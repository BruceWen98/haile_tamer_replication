...
def newton_method_repeated(i,n,H, max_iters=100, tries=20):
    try:
        try1 = -100
        attempts = 0
        while (try1 < 0 or try1 > 1) and (attempts<tries):
...
# for i in range(1000):
#     print(newton_method_repeated(10,15,testing))
