...
def run_AL_profits_specificN_Data(INPATH, OUTPATH, n, UB_V=15, num_points=1000):
    ...
    KDEs = AL.getAll_KDEs(3,data_dicts)     # comment if not using variedN
...
INPATH = str(f)
OUTPATH = "/Users/brucewen/Desktop/honors_thesis/estimation/simulations/varyingN/results/" + INPATH.split("/")[-1]

run_AL_profits_specificN_Data(INPATH, OUTPATH, n=3, UB_V=20, num_points=50)