...
def filter_MAIN(dicts, loc=None, cat0=None, cat1=None, 
                ...
                min_count_Estimate=5, min_count_N=10):
...
#     7) art, impressionist/20th/21st century art, paris
#     8) art, old masters
#     9) luxury goods, jewelry OR watches, new york
...
# make_Aggregated(output_dicts, 'ALL_d_par_art_imp20', cat0='art', cat1='impressionist/20th/21st century art', loc='paris')
# make_LowMidHigh(output_dicts, 'art_imp20_par', cat0='art', cat1='impressionist/20th/21st century art', loc='paris')
